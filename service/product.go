 ...
 * @LastEditTime: 2024-07-26 10:16:17
...
func (service *ProuctService) Create(ctx context.Context, uId uint, files []*multipart.FileHeader) serializer.Response {
	var boss *model.User
	var err error
	code := e.Success
...
func (service *ProuctService) Show(ctx context.Context, id string) serializer.Response {
	code := e.Success
